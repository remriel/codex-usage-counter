...
- Branch: `agent/right-drag-history-pan`
...
- Hourly supports grab-style right-button panning at any zoom level. Dragging right moves toward older history; dragging left moves toward newer history. Left-button selection remains independent.
...
- Right-button pan stores the drag-start x-coordinate and viewport end, converts horizontal pixel displacement into the current wall-clock span, clamps to retained history, and restores live-following mode at the newest edge. Use a temporary move cursor while dragging.
...
- The right-drag-pan production build completed successfully and was installed in place. The installed executable matches the build (`E3ADAB4BDB2AA8221833DAA59E66295E4C3711BB152258BB1CA092A842BA0DAA`).

## Next steps

1. Manually inspect right-button Hourly history panning after release.
